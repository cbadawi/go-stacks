...
func (a *NonFungibleTokensAPIService) GetNftHistoryExecute(r ApiGetNftHistoryRequest) (*models.NonFungibleTokenHistoryEventList, *http.Response, error) {
	...
	if r.assetIdentifier == nil {
		return localVarReturnValue, nil, utils.ReportError("assetIdentifier is required and must be specified")
	}
	if r.value == nil {
		return localVarReturnValue, nil, utils.ReportError("value is required and must be specified")
	}
...
func (a *NonFungibleTokensAPIService) GetNftHoldingsExecute(r ApiGetNftHoldingsRequest) (*models.NonFungibleTokenHoldingsList, *http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.principal == nil {
		return localVarReturnValue, nil, utils.ReportError("principal is required and must be specified")
	}
