...
func (r ApiGetBurnBlockRequest) Execute() (*models.BurnBlock, *http.Response, error) {
...
*/
func (a *BurnBlocksAPIService) GetBurnBlock(ctx context.Context, heightOrHash models.GetBurnBlockHeightOrHashParameter) ApiGetBurnBlockRequest {
	return ApiGetBurnBlockRequest{
		ApiService:   a,
		ctx:          ctx,
...
//  @return BurnBlock
func (a *BurnBlocksAPIService) GetBurnBlockExecute(r ApiGetBurnBlockRequest) (*models.BurnBlock, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.BurnBlock
	)
