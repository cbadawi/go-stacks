...
func NewAPIClient(cfg *config.Configuration) *APIClient {
	...
	c.RosettaAPI = (*RosettaAPIService)(&c.common)
...
func (c *APIClient) callAPI(request *http.Request) (*http.Response, error) {
	c.cfg.Logger.TryLog("API Call", map[string]string{"path": request.URL.Path, "host": request.URL.Host})
	if c.cfg.Debug {
	...
	c.cfg.Logger.TryLog("API Call Response", map[string]string{"code": fmt.Sprint(resp.StatusCode), "status": resp.Status})
	return resp, err
}
